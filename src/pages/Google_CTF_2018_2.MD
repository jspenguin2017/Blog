...
I don't have the file on my server, but the cookies should land in the server
logs. It's time to send the email:
...
field. I hope you learnt something, stay tuned for next quests!
